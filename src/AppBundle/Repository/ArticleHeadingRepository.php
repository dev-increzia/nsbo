...
/**
 * ArticleHeadingRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class ArticleHeadingRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function findAllArticleHeadingByCommunity($community)
    {
        $qb = $this->createQueryBuilder('c');
        $qb->where('c.community = :community')->setParameter('community', $community);
        return $qb;
    ...
    public function findArticleheadingsByCommunity($community)
    {
        $qb = $this->createQueryBuilder('ah')
            ...
            ->andWhere('cs.slug = :setting')->setParameter('setting','activate_articles')
