...
/**
 * PhoneBookHeadingRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class PhoneBookHeadingRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function findArticleheadingsByCommunity($community)
    {
        $qb = $this->createQueryBuilder('ah')
            ...
            ->andWhere('cs.slug = :setting')->setParameter('setting','activate_phonebook')
    ...
    public function findPhoneBookHeadingByCommunity($community)
    {
        $qb = $this->createQueryBuilder('ah')
            ->innerJoin('ah.community','c')
            ->innerJoin('c.settings','cs')
